...
df1 = pd.read_json(os.path.join('data', '2023_data.json'))
df2 = pd.read_json(os.path.join('data', '2022_data.json'))
df3 = pd.read_json(os.path.join('data', '2021_data.json'))
df4 = pd.read_json(os.path.join('data', '2020_data.json'))
...
result2.columns = ['Total Commits', '5-Star total', '4-Star total', '3-Star total', 'Blue Chips Total', '2023 Blue Chip Ratio']
result = result2['2023 Blue Chip Ratio']
print(result)
