...
df1 = pd.read_json(os.path.join('data', '2021_data.json'))
df2 = pd.read_json(os.path.join('data', '2020_data.json'))
df3 = pd.read_json(os.path.join('data', '2019_data.json'))
df4 = pd.read_json(os.path.join('data', '2018_data.json'))
...
result2.columns = ['5-Star total', '4-Star total', '3-Star total', 'Total Commits', 'Blue Chips Total', '2021 Blue Chip Ratio']
result = result2['2021 Blue Chip Ratio']
print(result)
